...
import com.example.celfy.adapter.NavDrawerListAdapter;
import com.example.celfy.model.NavDrawerItem;
...
public class MainActivity extends Activity {
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			Intent a = new Intent(MainActivity.this,CamCapture.class);
			startActivity(a);
			break;
		case 2:
			...
			/*case R.id.changepassword :
                ...
                chgpassfr.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("https://xicer-h2ri.c9.io/api/chgpass",params);
                        if(json != null){
                            try{
