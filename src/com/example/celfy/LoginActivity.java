    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("https://xicer-h2ri.c9.io/login",params);
                if(json != null){
                try{
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                      ...
                      //  JSONObject json = sr.getJSON("http://192.168.56.1:8080/api/resetpass", params);
                        JSONObject json = sr.getJSON("https://xicer-h2ri.c9.io/api/resetpass", params);
                        if (json != null) {
                            try {
                                String jsonstr = json.getString("response");
                                if(json.getBoolean("res")){
                                ...
                                cont_code.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        JSONObject json = sr.getJSON("https://xicer-h2ri.c9.io/api/resetpass/chg", params);
                                        if (json != null) {
                                            try {
                                                String jsonstr = json.getString("response");
                                                if(json.getBoolean("res")){
